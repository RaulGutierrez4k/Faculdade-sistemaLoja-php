...
$alterar= mysql_query("UPDATE tb_produtos
                      SET pro_descricao='$pro_descricao1',tpp_codigo='$tpp_codigo1',pro_precocusto='$pro_precocusto1'
					  ,pro_precovenda='$pro_precovenda1',pro_estoque='$pro_estoque1',pro_embalagem='$pro_embalagem1',pro_ipi='$pro_ipi1'
