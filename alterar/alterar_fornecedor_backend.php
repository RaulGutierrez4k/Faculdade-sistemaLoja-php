...
$alterar= mysql_query("UPDATE tb_fornecedor
					  ...
					  ,for_endereco='$for_endereco1',for_numero='$for_numero1',for_bairro='$for_bairro1',for_cidade='$for_cidade1'
					  ,for_uf='$for_uf1',for_cnpjcpf='$for_cnpjcpf1',for_rgie='$for_rgie1',for_telefone='$for_telefone1'
