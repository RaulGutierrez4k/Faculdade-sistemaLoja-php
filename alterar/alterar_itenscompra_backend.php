...
$alterar= mysql_query("UPDATE tb_itenscompra
                      SET com_codigo='$com_codigo1',pro_codigo='$pro_codigo1',tpp_codigo='$tpp_codigo1'
					  ,nf_codigo='$nf_codigo1',for_codigo='$for_codigo1',tpg_codigo='$tpg_codigo1'
					  ,itc_embalagem='$itc_embalagem1',itc_qtde='$itc_qtde1',itc_valorun='$itc_valorun1'
					  ,itc_valorun='$itc_valorun1',itc_desc='$itc_desc1',itc_valortotal='$itc_valortotal1'
