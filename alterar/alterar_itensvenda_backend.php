...
$alterar= mysql_query("UPDATE tb_itensvenda
                      SET ven_codigo='$ven_codigo1',pro_codigo='$pro_codigo1',tpp_codigo='$tpp_codigo1'
					  ,nf_codigo='$nf_codigo1',tpg_codigo='$tpg_codigo1',fun_codigo='$fun_codigo1'
					  ,itv_embalagem='$itv_embalagem1',itv_qtde='$itv_qtde1',itv_valorun='$itv_valorun1'
					  ,itv_desc='$itv_desc1',itv_valortotal='$itv_valortotal1'
