...
$alterar= mysql_query("UPDATE tb_funcionario
                      SET fun_nome='$fun_nome1',fun_endereco='$fun_endereco1',fun_numero='$fun_numero1',fun_complemento='$fun_complemento1'
					  ,fun_bairro='$fun_bairro1',fun_cidade='$fun_cidade1',fun_uf='$fun_uf1',fun_cnpjcpf='$fun_cnpjcpf1'
					  ,fun_rgie='$fun_rgie1',fun_sexo='$fun_sexo1',fun_nascimento='$fun_nascimento1',fun_telefone='$fun_telefone1'
