...
<br> <p> Codigo: </p> <select size="1" name="cr_codigo">
<?php
...
<br> <p> Data vencimento.: </p>  
<input type="text" name="cr_datavencimento">
<br> <p> Data recebimento.:</p>  
<input type="text" name="cr_datarecebimento">

<br> <p> Codigo nota fiscal: </p> <select size="1" name="nf_codigo">
